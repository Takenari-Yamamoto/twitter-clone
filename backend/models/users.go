...
var (
	userAllColumns            = []string{"id", "username", "email", "password_hash", "display_name", "bio", "avatar_url", "created_at", "updated_at"}
	userColumnsWithoutDefault = []string{"username", "email", "password_hash", "display_name", "bio", "avatar_url"}
