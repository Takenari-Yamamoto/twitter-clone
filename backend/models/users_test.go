...
var (
	userDBTypes = map[string]string{`ID`: `bigint`, `Username`: `varchar`, `Email`: `varchar`, `PasswordHash`: `varchar`, `DisplayName`: `varchar`, `Bio`: `text`, `AvatarURL`: `varchar`, `CreatedAt`: `timestamp`, `UpdatedAt`: `timestamp`}
	_           = bytes.MinRead
)
