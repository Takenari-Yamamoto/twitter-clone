...
var TweetWhere = struct {
	...
	UserID:    whereHelperint64{field: "`tweets`.`user_id`"},
...
var (
	tweetAllColumns            = []string{"id", "user_id", "content", "created_at", "updated_at"}
	tweetColumnsWithoutDefault = []string{"user_id", "content"}
